...
```{python}
EXCEL_PATH = "../excel/ai-post-pretrain.xlsx"
EXCEL_PATH2 = "../excel/post-train-data.xlsx"
MODEL_CHECKPOINT = "../results/checkpoint-2565"
```
...
```{python}
# Define the model, specifying we have 4 labels
