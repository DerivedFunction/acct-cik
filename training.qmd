...
```{python}
EXCEL_PATH = "./excel/training-post-output.xlsx"
DUMMY_EXCEL_PATH = "./excel/training-post-output-dummy.xlsx"
...
```{python}
# Move the checkpoint to the out of the folder
# %mv ./results/checkpoint-00 .
```
