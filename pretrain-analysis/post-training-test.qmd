...
id2label = {0: "0: Confirmed derivative usage",
            1: "1: Likely derivative usage",
            2: "2: Mentioned derivative usage",
            3: "3: Irrelevant"}
```
```{python}
batch_size = 20  # Adjust this value based on your needs
m = 400  # Starting index
def modify_dict(case_labels):
    with open('modified_labels.txt', 'w', encoding='utf-8') as f:
