...
MODEL_PATH = '../results/checkpoint-140' 
...
id2label = {
    ...
    4: "Warrants and Derivative Liability",
}
...
case_labels = {
  101: 4,  # Warrant derivative liability expired → should be Derivative Liability/Warrants
  104: 4,  # Warrant derivative liability measured at fair value → Confirmed derivative usage
  106: 4,  # Change in derivative liability fair value mentioned in cash flows → Mentioned derivative usage
  113: 2,  # Change in fair value of derivative liability mentioned → Mentioned derivative usage
  117: 2   # Foreign currency forward contracts used for hedging → Mentioned derivative usage
}
