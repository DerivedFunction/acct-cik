...
def process_url(url: str, cik: int, year: int):
    ...
    if url.endswith("htm"):
        ...
        content = extract_content(text, True)
    else:
        debug_print("Processing as text")
        content = extract_content(text, False)
    return content
