...
def extract_content(data: str, asHTML=True) -> str:
    ...
    for para in paragraphs:
        ...
        # Remove F-1 F-2 F-3... F-10 ...
        para = re.sub(r"F-\d+", "", para)
...
def filter_by_keywords(content: str, year: int) -> dict:
    ...
    not_matches_keywords = [kw.lower() for kw in NOT_MATCHES_KEYWORDS]
    ...
    for paragraph in paragraphs:
        ...
        for idx, sentence in enumerate(sentences):
            ...
            if matches_text(final_sentence, keywords_lower):
                ...
                # Make sure it doesn't contain ignored keywords
                if any(kw in normalized for kw in ignore_keywords):
                    continue
                if any(kw in normalized for kw in not_matches_keywords):
                    continue
                count_non_matches += 1
...
def expand_sentences(df: pd.DataFrame, column: str) -> pd.DataFrame:
    ...
    # Example: df_expanded['sentence'] contains your text
    df_expanded['sentence'] = df_expanded['sentence'].apply(
