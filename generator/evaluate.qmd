---
title: "Derivative Classification Evaluation"
format: html
editor: source
jupyter: python3
---
...
MODEL_PATH = "DerivedFunction/finbert-derivative-type-classifier"
...
```{python}
UNLABELED_EXCEL_PATH = "../excel/training_data.xlsx"
...
```{python}
result_dict = getBatch(100, 0)  # Initial batch write
```
