...
pattern_nil = re.compile(r"nil (thousand|million|billion)", flags=re.IGNORECASE)
...
volume_units = ["barrels", "MMBtu", "MWh", "metric tons", "bushels", "gallons"]
assessment_verbs = [
    "assessed",
    "evaluated",
    "tested",
...
embedded_fx_templates = [
    ...
    "Lease agreements with rental payments linked to {currency_pair} expose the Company to embedded foreign exchange derivative features",
...
embedded_past_templates = [
    ...
    "Management notes that as of {month} {end_day}, {current_year}, the Company no longer maintains any embedded derivative positions",
]
...
hedge_past_event_template = [
    "In {month} {year}, {company} {verb} {swap_type} agreements with a total notional amount of {currency_code}{amount} {money_unit}, resulting in fair value losses recorded in equity",
    "In the {quarter} quarter of {year}, {company} {verb} {swap_type} agreements with a total notional amount of {currency_code}{amount} {money_unit}, resulting in fair value losses recorded in equity",
    ...
    "During the {quarter} of {year}, {swap_type} were designated as {hedge_type} hedges, resulting in {currency_code}{amount} {money_unit} of unrealized losses recorded in accumulated OCI",
]
...
hedge_position_templates = [
    ...
    "{company}’s {swap_type} contracted in {old_year} remain outstanding as of {year}, with a notional balance of {currency_code}{notional} {money_unit}, scheduled to mature in {future_year}",
    "To manage exposure, {company} {verb} {swap_type} in {old_year}, with an inception notional of {currency_code}{notional} {money_unit} and a stated maturity in {future_year}",
    "In {month} {old_year}, {company} {verb} {swap_type} with notional amounts of {currency_code}{notional} {money_unit}, which are set to expire in {month} {future_year}",
    "As of {month} {year}, {company} {verb} {swap_type} {verb} in {old_year}, with total notional of {currency_code}{notional} {money_unit}, expiring in {future_year}",
...
eq_position_templates = [
    ...
    "At year-end {year}, {company} {verb} {swap_type} outstanding to hedge variability in compensation expense associated with changes in the company’s share price",
    ...
    "{company}’s derivative portfolio at {month} {end_day}, {year} includes {swap_type} used to manage market risks associated with fluctuations in the company’s stock price",
    ...
    "As of {month} {end_day}, {year}, {company} has {swap_type} outstanding with a notional amount of {currency_code}{notional} {money_unit} to offset potential volatility from changes in its share price",
    ...
    "As of {month} {end_day}, {year}, outstanding {swap_type} totaling {currency_code}{notional} {money_unit} remain designated as economic hedges of the company’s share price exposure",
    ...
    "To manage share price exposure, {company} {verb} {swap_type} in {old_year}, with an inception notional of {currency_code}{notional} {money_unit} and a stated maturity in {future_year}",
    "In {month} {old_year}, {company} {verb} {swap_type} with notional amounts of {currency_code}{notional} {money_unit}, which are set to expire in {month} {future_year}, to offset volatility in stock-based compensation expense",
    "As of {month} {year}, {company} {verb} {swap_type} {verb} in {old_year}, with total notional of {currency_code}{notional} {money_unit}, expiring in {future_year}, to hedge changes in equity valuation",
...
hedge_transaction_templates = [
    "Each transaction requires quarterly settlement of {currency_code}{notional} {money_unit} resulting in all gains and losses being realized and recorded",
    "Each transaction requires annual settlement of {currency_code}{notional} {money_unit} resulting in all gains and losses being realized and recorded",
    "Each {swap_type} requires quarterly settlement of {currency_code}{notional} {money_unit} resulting in all gains and losses being realized and recorded",
    "Each {swap_type} requires annual settlement of {currency_code}{notional} {money_unit} resulting in all gains and losses being realized and recorded",
]
...
hedge_effectiveness_templates = [
    "{company} {verb}, both at inception and on an on-going basis, whether the derivative instruments that are utilized in {hedge_type} hedging transactions are highly effective in offsetting the {metric} of hedged items",
...
fx_ir_debt_optimization_templates = [
    "{company} {verb} {swap_type} to optimize the cost and risk profile of its debt portfolio, adjusting both interest rate and currency exposures",
    "To manage borrowing costs and currency risk, {company} {verb} {swap_type} to modify the effective interest rate and currency mix of outstanding debt",
    ...
    "As part of its debt strategy, {company} {verb} {swap_type} to transform debt characteristics, including both fixed/floating rate and currency composition",
    "To hedge against interest rate and foreign exchange risks, {company} applies {swap_type} to optimize its debt obligations",
    "{company} {verb} {swap_type} to manage exposure to both interest rate changes and currency fluctuations across its debt portfolio",
    "{company} {verb} {swap_type} to balance interest rate and currency risk, converting portions of debt as needed",
...
derivative_template = {
    ...
    "CP_PLACEHOLDER": ["commodity price", "commodity-related"],
    "CP_TYPES": [
        "swap",
        "forward",
        "option",
...
derivative_keywords = {
    ...
    "gen": expand_derivative_terms([], [], derivative_template["GEN_STANDALONE"]),
}
...
cp_position_template = [
    ...
    "At year-end {year}, {company} had {swap_type} outstanding with aggregate notional values of {currency_code}{notional} {money_unit} designated to manage commodity exposures",
    ...
    "At year-end {year}, {company} holds {swap_type} with a total notional value of {currency_code}{notional} {money_unit} to manage fluctuations in commodity prices",
    ...
    "During {year}, {company} {verb} {swap_type} with a total notional value of {currency_code}{notional} {money_unit} to hedge volatility in raw material costs",
    ...
    "{company} holds {swap_type} as of {month} {end_day}, {year}, with notional values of {currency_code}{notional} {money_unit} to hedge {commodity} exposures",
    ...
    "In {old_year}, {company} {verb} {swap_type} with a notional volume equivalent of {currency_code}{notional} {money_unit}, set to expire in {future_year}",
    "During {old_year}, {company} {verb} {swap_type} to manage raw material exposure, with a notional of {currency_code}{notional} {money_unit}, terminating in {future_year}",
    "{company} {verb} {swap_type} in {month} {old_year} to lock in pricing, covering {currency_code}{notional} {money_unit}, expiring in {month} {future_year}",
    "At year-end {year}, {company} held {swap_type} initiated in {old_year}, with outstanding notional amounts of {currency_code}{notional} {money_unit}, maturing in {future_year}",
    # --- NEW TWO-YEAR DISCLOSURE ADDITIONS (with {month} and {end_day}) ---
    ...
    "As of {month} {end_day}, {year} and {prev_year}, {company} {verb} {swap_type} contracts totaling {currency_code}{notional} {money_unit} and {currency_code}{prev_notional} {money_unit}, respectively, to manage raw material cost volatility",
...
cp_specific_templates = [
    "{company} {verb} {swap_type} to hedge exposure to {commodity} price volatility affecting {cost_type}",
    "{company} enters into {swap_type} to manage the financial impact of fluctuations in {commodity} prices",
    "{swap_type} are {verb} to hedge anticipated {commodity} purchases totaling {volume} {volume_unit} over the next {months} months",
    "In {month} {year}, {company} {verb} {swap_type} to lock in {commodity} prices for {volume} {volume_unit} of forecasted consumption",
    "Commodity price risk related to {commodity} is managed through {swap_type} with notional volumes of {volume} {volume_unit}",
    "{company} {verb} {swap_type} to hedge {commodity} price exposure on production inputs",
    "{company} {verb} {swap_type} to stabilize {cost_type} by hedging approximately {pct}% of anticipated {commodity} requirements",
    "{swap_type} are designated as cash flow hedges of forecasted {commodity} purchases at fixed prices averaging {currency_code}{price} per {volume_unit}",
    "{company} {verb} {swap_type} to mitigate {commodity} price risks impacting {cost_type} for {volume} {volume_unit}",
    "To secure stable {cost_type}, {company} {verb} {swap_type} for {commodity} with maturities extending to {months} months",
    "{company}'s {swap_type} cover {pct}% of {commodity} needs, reducing exposure to price swings in {cost_type}",
    "In response to {commodity} market trends, {company} adjusts {swap_type} positions for {volume} {volume_unit} to manage {cost_type}",
    "{company} hedges {commodity} price risk through {swap_type}, targeting {pct}% of projected {cost_type} over {months} months",
]
cp_context_templates = [
    "{company} {verb} commodity contracts and derivatives to manage price exposure to {commodity}",
    "Changes in commodity prices affect {company}'s cost of goods sold and gross margins",
    "To hedge commodity price fluctuations, {company} enters into forwards, futures, and swaps on key {commodity}",
    ...
    "Fluctuations in raw material prices may lead to adjustments in {company}'s pricing strategies",
    ...
    "{company} {verb} fixed-price contracts to lock in costs for critical commodities and reduce volatility",
]
cp_impact_templates = [
    "Fluctuations in {commodity} prices {verb} the reported cost of goods sold and operating margins",
    "Changes in {commodity} market prices {verb} {company}'s financial performance and net asset values",
    ...
    "Shifts in {commodity} market values {verb} the financial results of {company}'s operations",
    "Changes in {commodity} prices {verb} forecasted revenue and cash flow from operations",
    "{commodity} market fluctuations {verb} the valuation of inventory and derivative hedges",
    ...
    "{company} purchase the majority of our {commodity} at prevailing market prices, and seek to manage market risk through execution of a documented hedging strategy and other means",
...
cp_may_use_templates = [
    "{company} {verb} {swap_type} to manage the volatility of {commodity} prices",
    "{company} {verb} {swap_type} to reduce the risk of fluctuations in raw material costs",
    "{company} {verb} {swap_type} to stabilize operating costs tied to {commodity} inputs",
    "{company} {verb} {swap_type} to protect margins from unexpected {commodity} price movements",
    "{company} {verb} {swap_type} to lock in pricing for forecasted {commodity} purchases",
]
...
fx_position_template = [
    "In {month} {old_year}, {company} {verb} {swap_type} with notional amounts of {currency_code}{notional} {money_unit}, maturing in {month} {future_year}",
    "During {prev_year}, {company} {verb} {swap_type} to manage translation exposure, with an inception notional of {currency_code}{notional} {money_unit}, set to expire in {future_year}",
    "{company} {verb} {swap_type} in {prev_year}, designed to hedge foreign borrowings with notional values of {currency_code}{notional} {money_unit}, terminating in {future_year}",
    "As of {year}, {company} continues to hold {swap_type} contracted in {old_year}, with outstanding notional balances of {currency_code}{notional} {money_unit}, expiring in {future_year}",
    ...
    "As of {month} {year}, {company}’s outstanding {swap_type} have a notional value of {currency_code}{notional} {money_unit}, hedging intercompany loans denominated in foreign currencies",
    ...
    "In {month} {old_year}, {company} {verb} {swap_type} with a notional amount of {currency_code}{notional} {money_unit}, scheduled to expire in {month} {future_year} to manage currency risk",
    "During {old_year}, {company} {verb} {swap_type} to hedge forecasted foreign currency expenditures, with an initial notional of {currency_code}{notional} {money_unit}, maturing in {future_year}",
    "As part of its treasury risk management program, {company} {verb} {swap_type} in {old_year}, which carry notional amounts of {currency_code}{notional} {money_unit} and terminate in {future_year}, mitigating exposure to foreign currency fluctuations",
    "In {month} {old_year}, {company} {verb} {swap_type} with a starting notional of {currency_code}{notional} {money_unit}, reducing over time until expiration in {month} {future_year}, designated as hedges of currency-denominated obligations",
    # --- NEW TWO-YEAR DISCLOSURE ADDITIONS ---
    "At {month} {end_day}, {year} and {prev_year}, {company} held {currency_code}{notional} {money_unit} and {currency_code}{prev_notional} {money_unit}, respectively, of {swap_type} outstanding to hedge foreign currency exposures",
    ...
    "As of {month} {end_day}, {year} and {prev_year}, {company} held {swap_type} contracts with notional amounts of {currency_code}{notional} {money_unit} and {currency_code}{prev_notional} {money_unit}, respectively, protecting against currency fluctuations",
    ...
    "At {month} {end_day}, {year} and {prev_year}, {company} held active {swap_type} contracts totaling {currency_code}{notional} {money_unit} and {currency_code}{prev_notional} {money_unit}, respectively, hedging foreign-denominated cash flows",
...
fx_mitigation_templates = [
    ...
    "{company} centrally manages subsidiary liquidity and {swap_verb} {swap_type} to hedge foreign exchange exposure on intercompany funding arrangements",
    ...
    "{company} {swap_verb} {swap_type} to hedge foreign currency risk on centrally managed subsidiary funding and cash movements",
    "{company} may use {swap_type} to adjust the currency profile of its debt portfolio as needed",
    "{company} {swap_verb} {swap_type} to modify the currency composition of borrowings based on operational needs",
    "{swap_type} are {swap_verb} to convert borrowings into {major_currency} when strategically beneficial",
    ...
    "{swap_type} are marked-to-market with the resulting gains or losses reflected in Accumulated other comprehensive income (loss)",
]
...
fx_alternative_management_templates = [
    ...
    "{company} may designate foreign currency-denominated debt as a hedge of net investments in foreign subsidiaries",
    "To manage foreign exchange risk, {company} {may_verb} {swap_type} to align debt currency with underlying cash flow exposures",
    ...
    "As part of its risk management strategy, {company} {may_verb} {swap_type} to fund operations with foreign-denominated debt to mitigate translation risk",
]

fx_generic_hedge_templates = [
    '{company} may choose to hedge against possible fluctuations in foreign subsidiaries net assets ("{hedge_type} hedge") and {verb} {swap_type} and {swap_type2} in the past in order to hedge such an exposure',
    ...
    "These {swap_type} are designated as {hedge_type} hedges of the variability of the cash flows due to changes in foreign currency exchange rates",
]
...
fx_debt_optimization_templates = [
    ...
    "{company} applies {swap_types} to manage foreign exchange exposure on international debt, mitigating translation and transaction risk",
    ...
    "To stabilize the currency profile of debt, {company} applies {swap_types} converting obligations into {currency_code} where beneficial",
...
fx_may_use_templates = [
    "{company} {verb} {swap_type} to mitigate exposure to foreign currency movements",
    "{company} {verb} {swap_type} to manage risks related to forecasted foreign transactions",
    "{company} {verb} {swap_type} to offset volatility from translating foreign subsidiaries’ results",
    "{company} {verb} {swap_type} to reduce the impact of exchange rate fluctuations on cash flows",
    "{company} {verb} {swap_type} to protect against adverse changes in cross-border financing costs",
]
```
...
ir_past_event_templates = [
    "During {month} {year}, {company} {verb} {swap_type} in anticipation of issuing fixed-rate notes, leaving {currency_code}{amount} {money_unit} of unrealized losses in OCI related to {swap_type} as of {month} {next_year}",
    "In {month} {year}, {company} {verb} {swap_type} with a notional value of {currency_code}{amount} {money_unit} to hedge forecasted debt issuances, resulting in deferred losses recorded in accumulated OCI",
    ...
    "During {year}, {swap_type} were {verb} to lock in favorable rates prior to debt refinancing, with {currency_code}{amount} {money_unit} of accumulated losses deferred in other comprehensive income",
    "In {month} {year}, {company} {verb} forward-starting {swap_type} in connection with planned debt offerings, recording {currency_code}{amount} {money_unit} of mark-to-market losses in OCI",
    "In {month} {year}, {company} {verb} {swap_type} to manage interest rate risk, recognizing {currency_code}{amount} {money_unit} in unrealized gains in OCI as of {month} {next_year}",
    "During {year}, {company} {verb} {swap_type} to hedge against fluctuations in interest rates, with {currency_code}{amount} {money_unit} in deferred gains recorded in accumulated OCI",
    ...
    "in the {quarter} quarter of {year}, {company} {verb} forward-starting {swap_type} to secure rates for future debt issuances, with {currency_code}{amount} {money_unit} in mark-to-market adjustments in OCI",
    "In {year}, {company} {verb} {swap_type} to mitigate interest rate exposure, with {currency_code}{amount} {money_unit} in fair value changes deferred in equity",
    ...
    "during the {quarter} quarter of {year}, {company} {verb} {swap_type} to hedge planned bond issuances, with {currency_code}{amount} {money_unit} in unrealized losses recorded in OCI",
    "In {month} {year}, {swap_type} were {verb} to manage exposure to interest rate volatility, resulting in {currency_code}{amount} {money_unit} of deferred gains in equity",
    "{company} {verb} {swap_type} in {month} {year} to hedge forecasted interest payments, with {currency_code}{amount} {money_unit} in mark-to-market adjustments in OCI",
    ...
    "in the {quarter} quarter of {year}, {swap_type} were {verb} to manage interest rate risk on future borrowings, with {currency_code}{amount} {money_unit} in losses recorded in equity",
    "{company} {verb} {swap_type} in {month} {year} to hedge against rising interest rates, deferring {currency_code}{amount} {money_unit} in mark-to-market losses in OCI",
    "In {month} {year}, {company} {verb} {swap_type} with a notional value of {currency_code}{amount} {money_unit}, resulting in deferred gains recorded in accumulated OCI",
    "During {year}, {company} {verb} {swap_type} to lock in rates for planned financings, with {currency_code}{amount} {money_unit} in fair value adjustments in OCI",
...
ir_position_template = [
    ...
    "In {month} {old_year}, {company} {verb} {swap_type} with a notional amount of {currency_code}{notional} {money_unit}, scheduled to expire in {month} {future_year}",
    "During {old_year}, {company} {verb} {swap_type} to hedge debt obligations, with an initial notional of {currency_code}{notional} {money_unit}, maturing in {future_year}",
    "As part of its bond financing strategy, {company} {verb} {swap_type} in {old_year}, which carry notional amounts of {currency_code}{notional} {money_unit} and terminate in {future_year}",
    "In {month} {old_year}, {company} {verb} {swap_type} with a starting notional of {currency_code}{notional} {money_unit}, declining annually until expiration in {month} {future_year}",
    # --- NEW TWO-YEAR DISCLOSURE ADDITIONS (with {month} and {end_day}) ---
...
ir_optional_templates = [
    "In anticipation of issuing fixed-rate debt, {company} {verb} {swap_type} that are designated as {hedge_type} hedges to hedge against changes in interest rates that could impact expected future issuances of debt",
    "{company} {verb} {swap_type} designated as {hedge_type} hedges to lock in favorable interest rates prior to anticipated debt issuances",
    "To hedge interest rate exposure on forecasted debt offerings, {company} {verb} {swap_type} designated as {hedge_type} hedges",
    "{swap_type} are {verb} to mitigate the risk of rising interest rates on planned fixed-rate debt issuances",
    "{company} {verb} {swap_type} as {hedge_type} hedges to secure interest rates for future debt issuances",
    "In preparation for debt offerings, {company} may designate {swap_type} as {hedge_type} hedges to manage interest rate risk",
    "To protect against interest rate volatility, {company} {verb} {swap_type} for planned fixed-rate debt issuances",
    "{swap_type} are {verb} as {hedge_type} hedges to lock in rates for anticipated debt financings",
    "In anticipation of bond issuances, {swap_type} are designated as {hedge_type} hedges to stabilize future interest costs",
    "{company} {verb} {swap_type} to mitigate interest rate fluctuations on planned debt offerings",
    "{swap_type} are designated as {hedge_type} hedges to secure rates for future fixed-rate debt",
    "To manage interest rate exposure, {company} {verb} {swap_type} for anticipated debt issuances",
    "{company} {verb} {swap_type} as {hedge_type} hedges to lock in rates prior to debt financings",
    "{swap_type} are {verb} to hedge against rising interest rates for planned debt issuances",
    "In preparation for fixed-rate debt, {company} designates {swap_type} as {hedge_type} hedges",
    "{company} {verb} {swap_type} to stabilize interest rates for forecasted bond issuances",
    "{swap_type} are implemented as {hedge_type} hedges to manage risk on future debt offerings",
    "To secure favorable rates, {company} {verb} {swap_type} for anticipated fixed-rate debt",
    ...
    "{company} {verb} {swap_type} to manage cash flow interest rate exposure, with quarterly settlements based on the differential between fixed and floating rates on notional amounts",
    ...
    "{company} {verb} {swap_type} converting floating rate exposure to fixed rates, with quarterly exchange of payment differentials based on notional values",
]
...
ir_context_templates = [
    ...
    "{company} {verb} two derivative financial instruments to manage our variable interest rate exposure",
]
# Interest Rate (IR) Debt Optimization Templates
ir_debt_optimization_templates = [
    "{company} {verb} {swap_type} to optimize the interest rate profile of its debt portfolio, converting portions of fixed-rate debt to floating-rate instruments",
    "To manage borrowing costs, {company} {verb} {swap_type} to adjust the effective interest rate composition of outstanding debt",
    "{company} implements {swap_type} to reduce interest rate volatility on its debt obligations",
    "As part of its debt strategy, {company} {verb} {swap_type} to transform fixed-rate debt into variable-rate debt where appropriate",
    "To hedge against rising interest rates, {company} applies {swap_type} to modify the interest rate characteristics of its borrowings",
    "{company} {verb} {swap_type} to manage the interest rate exposure of its long-term debt portfolio",
    "{company} {verb} {swap_type} to convert portions of debt into instruments with more favorable interest rate terms",
    "{company} optimizes its debt by using {swap_type} to balance fixed and floating rate obligations",
    "To stabilize interest expense, {company} applies {swap_type} to its debt portfolio, managing cash flow risk",
    "{company} manages interest rate risk on forecasted debt issuances using {swap_type} to adjust the effective interest profile",
    "{company}'s objectives in interest rate risk management are to limit the negative impact of interest rates by using {swap_type}",
]

ir_may_use_templates = [
    "{company} {verb} {swap_type} to hedge against fluctuations in interest rates",
    "{company} {verb} {swap_type} to manage exposure to changes in benchmark interest rates",
    "{company} {verb} {swap_type} to reduce cash flow variability from interest-bearing debt",
    "{company} {verb} {swap_type} to stabilize the cost of borrowing",
    "{company} {verb} {swap_type} to protect against unfavorable changes in long-term debt obligations",
    "{company} {verb} {swap_type} to hedge interest rate risk on forecasted debt issuances",
]
...
# Common SEC patterns
headers = [
    "FORM 10-K", "FORM 10-Q", "FORM 8-K", "PROSPECTUS",
    "Table of Contents", "UNITED STATES SECURITIES AND EXCHANGE COMMISSION",
]

# Table of Contents patterns with placeholders for page numbers
sec_toc_patterns = [
    "Item 1. Business {page}",
    "A. History and Development of the Company {page}",
    ...
    "H. Purchases of Equity Securities by the Company and Affiliated Purchases {page}",
...
inventory_templates = [
    ...
    "Inventories are reviewed periodically for slow-moving or obsolete items, with reserves recorded when necessary to reduce carrying values",
    "Finished goods and work in progress are stated at standard cost (approximating actual cost) under the {method} method, adjusted to net realizable value if necessary",
    "Raw materials are valued at purchase cost while manufactured inventories include labor and overhead allocated using the {method} method",
    "Inventory is written down to market value when estimated selling prices are less than cost",
    ...
    "Inventories include supplies and components valued at the lower of cost (determined by {method}) or net realizable value",
    "{company} records provisions for excess and obsolete inventories based on expected future demand, market conditions, and product life cycles",
]
...
inventory_writedown_templates = [
    ...
    "As of {month} {end_day}, {year}, {company} maintained reserves of {currency_code}{amount} {money_unit} for excess and obsolete inventories",
    ...
    "Inventory reserves increased to {currency_code}{amount} {money_unit} at year-end {year}, reflecting adjustments for lower selling prices and product obsolescence",
...
def generate_derivative_liability_paragraph(
    ...
    if label_type in [4, 5]:
        ...
        event = random.choice(warrant_events)
        sentence = template.format(location=location, company=pick_company_name(company_name), event=event)
        all_sentences.append(sentence)
    ...
    # ============ LABELS 6 & 7: EMBEDDED DERIVATIVES ============
        ...
        if not is_past and random.random() < 0.4:
            ...
            verb = random.choice(assessment_verbs)
            sentence = sentence.format(verb=verb, company=company_name)
            all_sentences.append(sentence)
        ...
        for _ in range(0, max_len):
            ...
            if noncash_type == "stock_debt":
                ...
                sentence = template.format(company=pick_company_name(company_name), shares=f"{shares:,}")
    ...
    paragraph = pattern_nil.sub("nil", paragraph)
...
def generate_labeled_hedge_paragraph(
    ...
    if has_active_derivative is None:
        ...
        if random.random() < 0.6:
            ...
            all_sentences.append(template.format(company=company_name))
        ...
        if random.random() < 0.8:
            ...
            verb = random.choice(hedge_mitigation_verbs)
            all_sentences.append(template.format(company=pick_company_name(company_name), verb=verb))
        ...
        if random.random() < 0.5:
            template = random.choice(fx_ir_debt_optimization_templates)
        ...
        all_sentences.append(
            nt_template.format(
                company=pick_company_name(company_name), verb=random.choice(hedge_may_use_verbs)
            )
        )

    # Labels 0 and 1: Specific positions
    else:
        # Add policy statements if needed
        if include_policy:
            # Accounting policy (0-1)
            if random.random() < 0.1:
                template = random.choice(hedge_policy_templates)
                swap_type = random.choice(swap_types)
                hedge_type = random.choice(hedge_types)
                all_sentences.append(
                    template.format(
            ...
            if random.random() < 0.1:
                ...
                all_sentences.append(
                    template.format(
                        company=pick_company_name(company_name), verb=random.choice(hedge_use_verbs)
                    )
                )
        # Hedge transaction
        if random.random() < 0.1:
        ...
        if not has_active_derivative:
            # Past event (0-1)
            if random.random() < 0.3 and len(past_years) > 0:
                template = random.choice(hedge_past_event_template)
                swap_type = random.choice(swap_types)
                ...
                all_sentences.append(sentence)
        # Foreign Exchange specific logic
        if swapType == "fx":
            # Context sentences
            if random.random() < 0.6:
            ...
            if random.random() < 0.7:
                ...
                verb = random.choice(hedge_mitigation_verbs)
                swap_verb = random.choice(hedge_use_verbs)
                swap_type = random.choice(swap_types)
                all_sentences.append(
                    template.format(
                        company=pick_company_name(company_name),
            ...
            if random.random() < 0.6:
                ...
                template = random.choice(fx_currency_templates)
                all_sentences.append(
                    template.format(
                        company=pick_company_name(company_name),
            ...
            if random.random() < 0.4:
                ...
                use_verb = random.choice(hedge_use_verbs)
                swap_type = random.choice(swap_types)
                all_sentences.append(
                    template.format(
                        may_verb=may_verb,
            ...
            if random.random() < 0.5:
                ...
                all_sentences.append(
                    template.format(
                        ...
                        hedge_type=hedge_type,
                        swap_type=random.choice(swap_types),
                        swap_type2=random.choice(swap_types),
                    )
                )
            ...
            # Label 0: Active derivative positions
            if has_active_derivative:
                # Active position (always for label 0)
                template = random.choice(fx_position_template)
                swap_type = random.choice(swap_types)
                notional = random.randint(50, 1000)
                prev_notional = random.randint(50, 1000)
                verb = random.choice(hedge_use_verbs)
                prev_year = current_year - 1
                old_year = random.choice(past_years) - 1 if past_years else prev_year
                future_year = random.randint(current_year + 1, current_year + 5)
                sentence = template.format(
                    company=pick_company_name(company_name),
                    verb=verb,
                    swap_type=swap_type,
                ...
                if random.random() < 0.5 and len(past_years) > 0:
                    template = random.choice(hedge_optional_templates)
                    verb = random.choice(hedge_use_verbs)
                    swap_type = random.choice(swap_types)
                    notional1 = random.randint(50, 1000)
                    notional2 = random.randint(50, 1000)
                    prev_year = past_years[-1]
                    sentence = template.format(
                        company=pick_company_name(company_name),
                        verb=verb,
                        swap_type=swap_type,
            ...
            # Label 1: No active derivative
            else:
                # Past position (always for label 1)
                template = random.choice(fx_position_template)
                swap_type = random.choice(swap_types)
                prev_notional = random.randint(50, 1000)
                verb = random.choice(hedge_use_verbs)
                if random.random() < 0.5: # Pick prev year
                    year = current_year - 1
                    notional = random.randint(50, 1000)
                else: # Set current year's value as 0
                    year = current_year
                    notional = random.choice(["0", "nil"])
                prev_year = year - 1
                old_year = random.choice(past_years) - 1 if past_years else prev_year
                future_year = random.randint(prev_year, year)
                sentence = template.format(
                    company=pick_company_name(company_name),
                    verb=verb,
                    swap_type=swap_type,
                ...
                if random.random() < 0.6:
                    ...
                    swap_type = random.choice(swap_types)
                    term_year = (
                        random.choice(past_years) if past_years else current_year
                    )
                    sentence = template.format(
                        company=pick_company_name(company_name),
                        swap_type=swap_type,
                ...
                # Past event with settlement (0-1)
                if random.random() < 0.5 and len(past_years) > 0:
                    template = random.choice(hedge_quarterly_event_templates)
                    swap_type = random.choice(swap_types)
                    past_year = random.choice(past_years)
                    notional = random.randint(50, 500)
                    settlement = random.randint(5, 50)
                    sentence = template.format(
                        company=pick_company_name(company_name),
                        swap_type=swap_type,
                        quarter=random.choice(quarters),
        ...
        # Interest Rate specific logic
            ...
            if has_active_derivative:
                # Entry sentence (0-1)
                if random.random() < 0.7:
                    template = random.choice(ir_entry_templates)
                    verb = random.choice(hedge_use_verbs)
                    swap_type = random.choice(swap_types)
                    notional = random.randint(100, 1000)
                    entry_year = (
                        random.choice(past_years) if past_years else current_year
                    )
                ...
                swap_type = random.choice(swap_types)
                notional = random.randint(100, 1000)
                prev_notional = random.randint(100, 1000)
                sentence = template.format(
                    company=pick_company_name(company_name),
                    verb=verb,
                    swap_type=swap_type,
                ...
                if random.random() < 0.5 and len(past_years) > 0:
                    ...
                    verb = random.choice(hedge_use_verbs)
                    swap_type = random.choice(swap_types)
                    notional1 = random.randint(100, 1000)
                    notional2 = random.randint(100, 1000)
                    prev_year = past_years[-1]
                    sentence = template.format(
                        company=pick_company_name(company_name),
                        verb=verb,
            ...
            # Label 1: No active derivative
                ...
                # Past event (0-1)
                if random.random() < 0.6 and len(past_years) > 0:
                    template = random.choice(ir_past_event_templates)
                    verb = random.choice(hedge_use_verbs)
                    swap_type = random.choice(swap_types)
                    past_year = random.choice(past_years)
                ...
                swap_type = random.choice(swap_types)
                prev_notional = random.randint(100, 1000)
                if random.random() < 0.5:  # Have previous years with amount
                    year = current_year - 1
                    notional = random.randint(100, 1000)
                else:  # Have current year have 0 amount
                    year = current_year
                    notional = random.choice(["0", "nil"])
                prev_year = year - 1
                old_year = random.choice(past_years) - 1 if past_years else prev_year
                future_year = random.randint(old_year, year)
                sentence = template.format(
                    company=pick_company_name(company_name),
                    verb=verb,
                    swap_type=swap_type,
                ...
                # Settlement event (0-1)
                if random.random() < 0.5 and len(past_years) > 0:
                    template = random.choice(hedge_quarterly_event_templates)
                    swap_type = random.choice(swap_types)
                    past_year = random.choice(past_years)
                    notional = random.randint(100, 500)
                    settlement = random.randint(10, 50)
                    sentence = template.format(
                        company=pick_company_name(company_name),
                        swap_type=swap_type,
                        quarter=random.choice(quarters),
        ...
        # Commodity Price specific logic
        elif swapType == "cp":
            ...
            if random.random() < 0.6:
                ...
                all_sentences.append(
                    template.format(
                        company=pick_company_name(company_name), verb=verb, commodity=commodity
                    )
                )
            ...
            if random.random() < 0.25:
                ...
                if random.random() < 0.3:  # Chance to replace with actual commodity
                    swap_type = re.sub("commodity", commodity, swap_type)
                all_sentences.append(
                    template.format(
                        company=pick_company_name(company_name),
                        verb=verb,
            ...
            if has_active_derivative:
                ...
                # Active position (always for label 0)
                template = random.choice(cp_position_template)  # Use position templates
                verb = random.choice(hedge_use_verbs)
                swap_type = random.choice(swap_types)
                notional = random.randint(50, 500)
                prev_notional = random.randint(50, 500)
                ...
                # CP specific template (0-1)
                if random.random() < 0.6:
                    template = random.choice(cp_specific_templates)
                    verb = random.choice(hedge_use_verbs)
                    swap_type = random.choice(swap_types)
            ...
            # Label 1: No active derivative
                ...
                if random.random() < 0.6:
                    ...
                    if random.random() < 0.3:  # Chance to replace with actual commodity
                        swap_type = re.sub("commodity", commodity, swap_type)
                    prev_notional = random.randint(5, 50)
                    if random.random() < 0.5: # Set notional for prev year
                        year = current_year - 1
                        notional = random.randint(5, 50)
                    else: # Or set current year as 0
                        year = current_year
                        notional = random.choice(["0", "nil"])
                    prev_year = year - 1
                    old_year = random.choice(past_years) - 1 if past_years else prev_year
                    future_year = random.randint(old_year, prev_year)
                    sentence = template.format(
                        company=pick_company_name(company_name),
                        verb=verb,
                        swap_type=swap_type,
        ...
        # Generic derivative logic (for 'gen' type or fallback)
        else:
            # Add generic context
            if random.random() < 0.6:
                template = random.choice(hedge_context_templates)
            ...
            if has_active_derivative:
                ...
                if random.random() < 0.85:
                    template = random.choice(hedge_position_templates)
                else:
                    template = random.choice(eq_position_templates)
                swap_type = random.choice(swap_types)
                notional = random.randint(50, 1000)
                prev_notional = random.randint(50, 1000)
                verb = random.choice(hedge_use_verbs)
    ...
    if len(all_sentences) < max_len:
        return generate_labeled_hedge_paragraph(
            has_active_derivative=has_active_derivative, swapType=swapType, max_len=3
        )
    ...
    # Error checking for unformatted placeholders
    if "{" in paragraph or "}" in paragraph:
        print(f"Error in format: {paragraph}")
...
def generate_accounting_noise_paragraph(
    year_range=(1990, 2025), max_len=random.randint(3, 5), company_name=None
):
    """
    ...
    for _ in range(num_litigation):
        if random.random() < 0.5:
            ...
            verb = random.choice(assessment_verbs)
            sentence = template.format(company=pick_company_name(company_name), verb=verb)
        else:
    ...
    for _ in range(num_exec_comp):
        ...
        all_sentences.append(sentence)
    if random.random() < 0.05:  # Generat of text and numbers
        noise = generate_sec_noise(company=pick_company_name(company_name), currency_unit=money_units, month=random.choice(months), year=current_year)
        all_sentences = noise
...
def generate_sec_noise(company, currency_unit, month, year):
    ...
    gibberish = ''.join(random.choices(string.ascii_lowercase + string.digits, k=random.randint(6,12))) + random.choice([".htm", ".txt"])
    
    # Randomly choose 8–15 fragments
    chunks = random.sample(headers + phrases + [gibberish] + [generate_toc_line()], k=random.randint(8, 15))
    return chunks
...
def generate(size_per_label=100):
    ...
    for prefix in swap_types:
        for _ in range(size_per_label):
            paragraph, label = generate_labeled_hedge_paragraph(
                has_active_derivative=True, swapType=prefix
            )
            all_samples.append((paragraph, label))

        for _ in range(size_per_label):
            paragraph, label = generate_labeled_hedge_paragraph(
                has_active_derivative=False, swapType=prefix
            )
            all_samples.append((paragraph, label))
