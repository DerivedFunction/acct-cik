    ...
    if has_active_derivative is None:
        ...
        if swapType == "fx":
            ...
            if random.random() < 0.10:
                ...
                all_sentences.append(
                    template.format(company=company_name, swap_types=selected_ir_list)
                )
    ...
    # Labels 0 and 1: Specific positions
        ...
        # Interest Rate specific logic
            ...
            if random.random() < 0.10:
                verb = random.choice(hedge_use_verbs)
                template = random.choice(ir_context_templates)
                all_sentences.append(template.format(company=company_name, verb=verb, swap_types=selected_ir_list))
            if random.random() < 0.05:
                template = random.choice(fx_ir_context_templates)
                all_sentences.append(template.format(company=company_name))
            # Label 0: Active derivative positions
