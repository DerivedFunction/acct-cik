    ...
    def generate_hedge_policy_update():
        ...
        if random.random() < 0.2:
            disclosure_line = random.choice(shared_disclosure_change_templates).format(
                company=company_name,
                disclosure_topic=random.choice(["derivative disclosures", "risk management strategies"]),
                disclosure_topic2=random.choice(["hedge effectiveness", "notional amounts"]),
                year=effective_year,
            )
        ...
        # ==============================
        evaluation_sentence = random.choice(shared_evaluation_templates).format(company=company_name)
...
def generate_accounting_noise_paragraph(
    ...
    if random.random() < 0.05: # Accounting standards
