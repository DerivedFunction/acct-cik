...
def generate_labeled_hedge_paragraph(
    ...
    def generate_ir_policy(current=False):
        ...
        sentences.append(
            template.format(
                company=pick_company_name(company_name), verb=verb, swap_types=selected_ir_list
            )
        )
    ...
    def generate_hedge_policy_update():
        ...
        # ==============================
        evaluation_sentence = random.choice(shared_evaluation_templates).format(company=pick_company_name(company_name))
