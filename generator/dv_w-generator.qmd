...
def generate_labeled_hedge_paragraph(
    ...
    def generate_fx_policy():
        ...
        if random.random() < 0.6:
            ...
            sentences.append(template.format(company=company_name))
    ...
    if has_active_derivative is None:
        ...
        if swapType == "fx":
            all_sentences.extend(generate_fx_policy())
        elif swapType == "ir":
            all_sentences.extend(generate_ir_policy())
        elif swapType == "cp":
            commodity = random.choice(commodities)
            all_sentences.extend(generate_cp_policy(commodity))
