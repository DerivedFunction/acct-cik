    ...
    def generate_derivative_sentences():
        ...
        if swapType == "fx" and random.random() < 0.6:
            ...
            currency_list = (
                ...
                if len(selected) > 1 else selected[0]
            )
            if random.random() < 0.3:
        ...
        if swapType == "fx":
            ...
            # generic fallback
            template = random.choice(
                hedge_position_templates if random.random() < 0.85 else eq_position_templates
            )
        ...
        future_year = (
            ...
            else random.randint(old_year, prev_year)
        )
