...
cp_position_template = [
    ...
    "As of {month} {end_day}, {year}, {company} {verb} active {swap_type} with a notional value of {currency_code}{notional} {money_unit}, while no comparable contracts existed during {prev_year} or {prev2_year}",
