                    ...
                    if active_type == "fx":
                        ...
                        if random.random() < 0.6:
                            ...
                            swap_type_selected = random.choice(
                                [s for s in swap_types if s in derivative_keywords["fx"]]
                            )
                        ...
                        if random.random() < 0.6:
                            ...
                            swap_type_selected = random.choice(
                                [s for s in swap_types if s in derivative_keywords["ir"]]
                            )
                        ...
                        if random.random() < 0.6:
                            ...
                            swap_type_selected = random.choice(
                                [s for s in swap_types if s in derivative_keywords["cp"]]
                            )
                            commodity = random.choice(commodities)
