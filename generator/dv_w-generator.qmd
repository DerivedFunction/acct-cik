...
shared_effective_date_templates = [
    ...
    "The Company must adopt this guidance no later than fiscal year {year}",
]

shared_adoption_status_templates = [
    "{company} adopted this guidance on {month} {day}, {year} using the {method}",
    "The Company adopted {standard} effective {month} {day}, {year}",
    "{company} early adopted the standard in {year}",
    "The Company will adopt the guidance in fiscal year {year}",
...
hedge_change_policy_templates = [
    ...
    "The amendment to Topic 815 {description} and {additional_feature}. Effective for fiscal years beginning after {month} {end_day}, {year}",
]
...
inventory_templates = [
    ...
    "Inventories include {items} valued at the lower of cost (determined by {method}) or net realizable value",
...
def generate_labeled_hedge_paragraph(
    ...
    def generate_hedge_policy(current=False):
        ...
        # --- Common shared pools (simplified names) ---
        issuers = shared_issuers
        purposes = shared_purposes
        adoption_methods = shared_adoption_methods
        eval_templates = shared_evaluation_templates
        adoption_status_templates = shared_adoption_status_templates
        eff_months = random.choice(months)
        ...
        topic = random.choice(
            ["derivatives and hedging", "hedging activities", "cash flow hedges", "fair value hedges"]
        )
        ...
        # ==============================
        adopt_template = random.choice(adoption_status_templates)
        adopt_standard = random.choice(hedge_standards)
        adopt_method = random.choice(adoption_methods)
        ...
        # ==============================
        evaluation_sentence = random.choice(eval_templates).format(company=company_name)
...
def generate_accounting_noise_paragraph(
    ...
    if random.random() < 0.10: # Accounting standards
        sentences = []
        # --- Common pools (simplified) ---
        issuers = shared_issuers
        purposes = shared_purposes
        adoption_methods = shared_adoption_methods
        eval_templates = shared_evaluation_templates
        ...
        issuer = random.choice(issuers)
        standard = random.choice(accounting_standards)
        topic = random.choice(
            ["financial instruments", "revenue recognition", "lease accounting", "fair value measurement"]
        )
        purpose = random.choice(purposes)
        description = random.choice(policy_descriptions)
        extra = random.choice(policy_features)
        ...
        # ==============================
        adopt_template = random.choice(adoption_status_templates)
        adopt_standard = random.choice(accounting_standards)
        adopt_method = random.choice(adoption_methods)
        adopt_month = random.choice(months)
        adopt_day = random.randint(1, 28)
        adopt_year = random.randint(current_year - 8, current_year + 4)
