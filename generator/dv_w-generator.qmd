...
cp_specific_templates = [
    ...
    "{company} {verb} {swap_type} to manage the financial impact of fluctuations in {commodity} prices",
...
cp_context_templates = [
    ...
    "{company} {verb} {swap_types} to lock in costs for critical commodities and reduce volatility",
]
cp_impact_templates = [
