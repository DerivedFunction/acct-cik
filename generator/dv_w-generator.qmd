...
def deboost_keywords_parallel(batch_size=20, max_words_per_sentence=3):
    ...
    words_to_deboost_label_3 = [
        ...
        "hedge fund", "warrant", "embedded", "warrants", "assets", "liabilities", "contract", "debt",  "liability", "derivative", "asset", "lawsuit", "loan", "bond", "strategies",
        "strategy",
    ...
    words_to_deboost_label_3.extend([
        "option", "collar", " call",
        "over-the-counter", "receive-equity", "pay-fixed",
        "receive-floating", "pay-equity", "pay-floating", "receive-fixed", "equity collar", "total return"
    ])
