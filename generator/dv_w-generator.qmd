...
def generate_accounting_noise_paragraph(
    ...
    if random.random() < 0.2:
        ...
        mission = "deliver innovative solutions that create value for customers and shareholders"
        month = random.choice(months)
        end_day = random.randint(28, 31)
    ...
    if random.random() < 0.25:
        ...
        if category == "forward_looking":
            ...
            sentence = random.choice(
                safe_harbor_templates.format(company=pick_company_name())
            )
    ...
    if random.random() < 0.15:
        ...
        agency3 = random.choice(
            [a for a in credit_agencies if a not in [agency, agency2]]
        )
