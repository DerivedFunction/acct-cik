...
fx_ir_debt_optimization_templates = [
    ...
    "The company {verb} {swap_type} to balance interest rate and currency risk, converting portions of debt as needed",
...
cp_specific_templates = [
    ...
    "The Company {verb} {swap_type} to stabilize {cost_type} by hedging approximately {pct}% of anticipated {commodity} requirements",
...
fx_debt_optimization_templates = [
    ...
    "The company {verb} {swap_types} to hedge foreign currency exposure on its international debt portfolio",
...
ir_debt_optimization_templates = [
    ...
    "The company {verb} {swap_type} to convert portions of debt into instruments with more favorable interest rate terms",
...
def generate_labeled_hedge_paragraph(
    ...
    if has_active_derivative is None:
        ...
        all_sentences.append(nt_template.format(
            company=company_name, 
            verb=random.choice(hedge_may_use_verbs)
            )
        )
    ...
    # Labels 0 and 1: Specific positions
        ...
        if include_policy:
            ...
            if random.random() < 0.5:
                ...
                all_sentences.append(template.format(
                    company=company_name,
                    verb=random.choice(hedge_use_verbs)
                    )
                )
        ...
        if swapType == "fx":
            ...
            # Label 1: No active derivative
                ...
                notional = random.randint(50, 1000)
                verb = random.choice(hedge_use_verbs)
                prev_year = random.choice(past_years) - 1 if past_years else current_year - 1
