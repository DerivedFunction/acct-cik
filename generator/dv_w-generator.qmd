...
embedded_no_longer_outstanding_templates = [
    ...
    "The Company has eliminated all embedded derivative liabilities from its financial statements as of {current_year}",
    ...
    "Management has determined that as of {month} {end_day}, {current_year}, the Company does not have any contracts requiring bifurcation of embedded derivatives",
