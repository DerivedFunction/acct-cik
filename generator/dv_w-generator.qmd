...
hedge_effectiveness_templates = [
    "{company} {verb}, both at inception and on an on-going basis, whether the derivative instruments that are {verb} in {hedge_type} hedging transactions are highly effective in offsetting the {metric} of hedged items",
...
fx_ir_debt_optimization_templates = [
    "{company} {hedge_change_verbs} {swap_type} to optimize the cost and risk profile of its debt portfolio, adjusting both interest rate and currency exposures",
    ...
    "As part of its debt strategy, {company} {hedge_change_verbs} {swap_type} to transform debt characteristics, including both fixed/floating rate and currency composition",
    "To hedge against interest rate and foreign exchange risks, {company} applies {swap_type} to optimize its debt obligations",
    "{company} {hedge_change_verbs} {swap_type} to manage exposure to both interest rate changes and currency fluctuations across its debt portfolio",
...
cp_position_templates = [
    ...
    "As of {month} {year}, {company} {hedge_change_verbs} {swap_type} with a notional value of {currency_code}{notional} {money_unit} to manage {commodity} price volatility",
...
cp_specific_templates = [
    "{company} {hedge_change_verbs} {swap_type} to hedge exposure to {commodity} price volatility affecting {cost_type}",
    ...
    "The Company {hedge_change_verbs} {swap_type} to stabilize {cost_type} by hedging approximately {pct}% of anticipated {commodity} requirements",
    ...
    "To secure stable {cost_type}, {company} {hedge_change_verbs} {swap_type} for {commodity} with maturities extending to {months} months",
...
cp_context_templates = [
    "{company} {hedge_change_verbs} commodity contracts and derivatives to manage price exposure to {commodity}",
    ...
    "{company} {hedge_change_verbs} fixed-price contracts to lock in costs for critical commodities and reduce volatility",
]
cp_impact_templates = [
...
fx_strategy_templates = [
    ...
    "As part of its risk management program, {company} {hedge_change_verbs} collar strategies combining {swap_type} to hedge currency exposure",
...
fx_mitigation_templates = [
    ...
    "{company} centrally manages subsidiary liquidity and {hedge_change_verbs} {swap_type} to hedge foreign exchange exposure on intercompany funding arrangements",
...
fx_debt_optimization_templates = [
    ...
    "To hedge foreign exchange risk, {company} {hedge_change_verbs} {swap_types} to convert borrowings from {currency_code} into its functional currency",
    ...
    "To manage currency risk, {company} {hedge_change_verbs} {swap_types} to modify the currency mix of its debt obligations",
    "{company} {hedge_change_verbs} {swap_types} to convert debt from {currency_code} into other currencies as part of its foreign exchange risk management strategy",
    ...
    "To reduce foreign exchange volatility, {company} {hedge_change_verbs} {swap_types} to optimize the composition of multi-currency debt",
]
```
...
ir_optional_templates = [
    ...
    "{company} {hedge_change_verbs} {swap_type} designated as {hedge_type} hedges to lock in favorable interest rates prior to anticipated debt issuances",
    ...
    "{company} {hedge_change_verbs} {swap_type} as {hedge_type} hedges to secure interest rates for future debt issuances",
    ...
    "{company} {hedge_change_verbs} {swap_type} to mitigate interest rate fluctuations on planned debt offerings",
    ...
    "{company} {hedge_change_verbs} {swap_type} to manage cash flow interest rate exposure, with quarterly settlements based on the differential between fixed and floating rates on notional amounts",
...
ir_debt_optimization_templates = [
    "{company} {hedge_change_verbs} {swap_type} to optimize the interest rate profile of its debt portfolio, converting portions of fixed-rate debt to floating-rate instruments",
    ...
    "As part of its debt strategy, {company} {hedge_change_verbs} {swap_type} to transform fixed-rate debt into variable-rate debt where appropriate",
    ...
    "{company} {hedge_change_verbs} {swap_type} to manage the interest rate exposure of its long-term debt portfolio",
