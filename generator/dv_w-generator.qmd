...
inventory_templates = [
    ...
    "As of {month} {end_day}, {year}, {company} {verb} obsolescence reserves of {currency_code}{reserve} {money_unit} against total inventories of {currency_code}{amount} {money_unit}",
...
inventory_writedown_templates = [
    ...
    "As of {month} {end_day}, {year}, {company} {verb} reserves of {currency_code}{amount} {money_unit} for excess and obsolete inventories",
...
def generate_labeled_hedge_paragraph(
    ...
    if has_active_derivative is None:
        ...
        may_use_template = random.choice(hedge_may_use_mitigation_templates)
        verb = random.choice(hedge_verbs)
        swap_type = random.choice(swap_types)
        all_sentences.append(
