...
def generate_labeled_hedge_paragraph(
    ...
    if has_active_derivative is None:
        if swapType == "gen":
            ...
            label = 10  # IR Hedge Speculative/Policy
        elif swapType == "fx":
            label = 13  # FX Hedge Speculative/Policy
        elif swapType == "cp":
        ...
        if swapType == "gen":
            ...
            label = 12  # FX Hedge Historic
        elif swapType == "cp":
            label = 15  # CP Hedge Historic
