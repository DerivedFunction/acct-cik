...
all_derivatives = list(derivative_keywords.values())
all_derivatives = [item for sublist in all_derivatives for item in sublist]
```
...
cp_context_templates = [
    "{company} uses commodity contracts and derivatives to manage price exposure to raw materials",
    "Changes in commodity prices affect {company}'s cost of goods sold and gross margins",
    "To hedge commodity price fluctuations, {company} enters into forwards, futures, and swaps on key raw materials",
...
cp_impact_templates = [
    ...
    "Price changes in key commodities {verb} the cost of raw materials and gross margins",
