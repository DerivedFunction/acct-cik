...
hedge_position_templates = [
    ...
    "{company}’s {swap_type} contracted in {old_year} remain outstanding as of {year}, with a notional balance of {currency_code}{prev_notional} {money_unit}, scheduled to mature in {future_year}",
    "To manage exposure, {company} {verb} {swap_type} in {old_year}, with an inception notional of {currency_code}{prev_notional} {money_unit} and a stated maturity in {future_year}",
    "In {month} {old_year}, {company} {verb} {swap_type} with notional amounts of {currency_code}{prev_notional} {money_unit}, which are set to expire in {month} {future_year}",
    "As of {month} {year}, {company} {verb} {swap_type} {verb} in {old_year}, with total notional of {currency_code}{prev_notional} {money_unit}, expiring in {future_year}",
...
eq_position_templates = [
    ...
    "To manage share price exposure, {company} {verb} {swap_type} in {old_year}, with an inception notional of {currency_code}{prev_notional} {money_unit} and a stated maturity in {future_year}",
    "In {month} {old_year}, {company} {verb} {swap_type} with notional amounts of {currency_code}{prev_notional} {money_unit}, which are set to expire in {month} {future_year}, to offset volatility in stock-based compensation expense",
    "As of {month} {year}, {company} {verb} {swap_type} {verb} in {old_year}, with total notional of {currency_code}{prev_notional} {money_unit}, expiring in {future_year}, to hedge changes in equity valuation",
...
cp_position_template = [
    ...
    "In {old_year}, {company} {verb} {swap_type} with a notional volume equivalent of {currency_code}{prev_notional} {money_unit}, set to expire in {future_year}",
    "During {old_year}, {company} {verb} {swap_type} to manage raw material exposure, with a notional of {currency_code}{prev_notional} {money_unit}, terminating in {future_year}",
    "{company} {verb} {swap_type} in {month} {old_year} to lock in pricing, covering {currency_code}{prev_notional} {money_unit}, expiring in {month} {future_year}",
    "At year-end {year}, {company} held {swap_type} initiated in {old_year}, with outstanding notional amounts of {currency_code}{prev_notional} {money_unit}, maturing in {future_year}",
    # --- NEW TWO-YEAR DISCLOSURE ADDITIONS (with {month} and {end_day}) ---
...
fx_position_template = [
    "In {month} {old_year}, {company} {verb} {swap_type} with notional amounts of {currency_code}{prev_notional} {money_unit}, maturing in {month} {future_year}",
    ...
    "As of {year}, {company} continues to hold {swap_type} contracted in {old_year}, with outstanding notional balances of {currency_code}{prev_notional} {money_unit}, expiring in {future_year}",
    ...
    "During {old_year}, {company} {verb} {swap_type} to hedge forecasted foreign currency expenditures, with an initial notional of {currency_code}{prev_notional} {money_unit}, maturing in {future_year}",
    "As part of its treasury risk management program, {company} {verb} {swap_type} in {old_year}, which carry notional amounts of {currency_code}{prev_notional} {money_unit} and terminate in {future_year}, mitigating exposure to foreign currency fluctuations",
    "In {month} {old_year}, {company} {verb} {swap_type} with a starting notional of {currency_code}{prev_notional} {money_unit}, reducing over time until expiration in {month} {future_year}, designated as hedges of currency-denominated obligations",
...
ir_position_template = [
    ...
    "In {month} {old_year}, {company} {verb} {swap_type} with a notional amount of {currency_code}{prev_notional} {money_unit}, scheduled to expire in {month} {future_year}",
    "During {old_year}, {company} {verb} {swap_type} to hedge debt obligations, with an initial notional of {currency_code}{prev_notional} {money_unit}, maturing in {future_year}",
    "As part of its bond financing strategy, {company} {verb} {swap_type} in {old_year}, which carry notional amounts of {currency_code}{prev_notional} {money_unit} and terminate in {future_year}",
    "In {month} {old_year}, {company} {verb} {swap_type} with a starting notional of {currency_code}{prev_notional} {money_unit}, declining annually until expiration in {month} {future_year}",
    # --- NEW TWO-YEAR DISCLOSURE ADDITIONS (with {month} and {end_day}) ---
...
def generate_accounting_noise_paragraph(
    year_range=(1990, 2025), max_len=random.randint(2, 3), company_name=None
):
    """
...
def generate(size_per_label=100):
    ...
    for prefix in swap_types:
        for _ in range(size_per_label // numSwaps):
        ...
        for _ in range(size_per_label // numSwaps):
            ...
            all_samples.append((paragraph, label))
        for _ in range(size_per_label // (numSwaps * 2)):
            paragraph, label = generate_labeled_hedge_paragraph(
                has_active_derivative=None, swapType=prefix
            )
            all_samples.append((paragraph, label))
