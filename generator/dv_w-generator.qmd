...
hedge_position_template = [
    ...
    "{company}’s {swap_type} contracted in {prev_year} remain outstanding as of {year}, with a notional balance of {currency_code}{notional} {money_unit}, scheduled to mature in {future_year}",
    "To manage exposure, {company} {verb} {swap_type} in {prev_year}, with an inception notional of {currency_code}{notional} {money_unit} and a stated maturity in {future_year}",
    "In {month} {prev_year}, {company} {verb} {swap_type} with notional amounts of {currency_code}{notional} {money_unit}, which are set to expire in {month} {future_year}",
    "As of {month} {year}, {company} {verb} {swap_type} {verb} in {prev_year}, with total notional of {currency_code}{notional} {money_unit}, expiring in {future_year}",
...
cp_position_template = [
    ...
    "In {prev_year}, {company} {verb} {swap_type} with a notional volume equivalent of {currency_code}{notional} {money_unit}, set to expire in {future_year}",
    "During {prev_year}, {company} {verb} {swap_type} to manage raw material exposure, with a notional of {currency_code}{notional} {money_unit}, terminating in {future_year}",
    "{company} {verb} {swap_type} in {month} {prev_year} to lock in pricing, covering {currency_code}{notional} {money_unit}, expiring in {month} {future_year}",
    "At year-end {year}, {company} held {swap_type} initiated in {prev_year}, with outstanding notional amounts of {currency_code}{notional} {money_unit}, maturing in {future_year}",
    # --- NEW TWO-YEAR DISCLOSURE ADDITIONS (with {month} and {end_day}) ---
...
fx_position_template = [
    "In {month} {prev_year}, {company} {verb} {swap_type} with notional amounts of {currency_code}{notional} {money_unit}, maturing in {month} {future_year}",
    ...
    "As of {year}, {company} continues to hold {swap_type} contracted in {prev_year}, with outstanding notional balances of {currency_code}{notional} {money_unit}, expiring in {future_year}",
    ...
    "In {month} {prev_year}, {company} {verb} {swap_type} with a notional amount of {currency_code}{notional} {money_unit}, scheduled to expire in {month} {future_year} to manage currency risk",
    "During {prev_year}, {company} {verb} {swap_type} to hedge forecasted foreign currency expenditures, with an initial notional of {currency_code}{notional} {money_unit}, maturing in {future_year}",
    "As part of its treasury risk management program, {company} {verb} {swap_type} in {prev_year}, which carry notional amounts of {currency_code}{notional} {money_unit} and terminate in {future_year}, mitigating exposure to foreign currency fluctuations",
    "In {month} {prev_year}, {company} {verb} {swap_type} with a starting notional of {currency_code}{notional} {money_unit}, reducing over time until expiration in {month} {future_year}, designated as hedges of currency-denominated obligations",
...
ir_position_template = [
    ...
    "In {month} {prev_year}, {company} {verb} {swap_type} with a notional amount of {currency_code}{notional} {money_unit}, scheduled to expire in {month} {future_year}",
    "During {prev_year}, {company} {verb} {swap_type} to hedge debt obligations, with an initial notional of {currency_code}{notional} {money_unit}, maturing in {future_year}",
    "As part of its bond financing strategy, {company} {verb} {swap_type} in {prev_year}, which carry notional amounts of {currency_code}{notional} {money_unit} and terminate in {future_year}",
    "In {month} {prev_year}, {company} {verb} {swap_type} with a starting notional of {currency_code}{notional} {money_unit}, declining annually until expiration in {month} {future_year}",
    # --- NEW TWO-YEAR DISCLOSURE ADDITIONS (with {month} and {end_day}) ---
    ...
    # Labels 0 and 1: Specific positions
        ...
        if swapType == "fx":
            ...
            if has_active_derivative:
                ...
                verb = random.choice(hedge_use_verbs)
                prev_year = random.choice(past_years) if past_years else current_year
            ...
            # Label 1: No active derivative
                ...
                verb = random.choice(hedge_use_verbs)
                prev_year = (
                    random.choice(past_years) - 1 if past_years else current_year - 1
                )
