...
hedge_position_templates = [
    ...
    "In {month} {year}, {company} {verb} {swap_type} with a total notional amount of {currency_code}{amount} {money_unit}, resulting in fair value losses recorded in equity",
    "In the {quarter} quarter of {year}, {company} {verb} {swap_type} with a total notional amount of {currency_code}{amount} {money_unit}, resulting in fair value losses recorded in equity",
