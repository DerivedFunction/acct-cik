...
hedge_past_event_template = [
    "In {month} {year}, {company} {hedge_use_verb} {swap_type} agreements with a total notional amount of {currency_code}{amount} {money_unit}, resulting in fair value losses recorded in equity",
...
hedge_optional_templates = [
    "{company} also have {hedge_use_verb} {swap_type} to hedge forecasted revenue which were not part of a collar strategy. Such {swap_type} had a notional value of {currency_code}{notional1} {money_unit} and {currency_code}{notional2} {money_unit} as of {month} {end_day}, {year} and {month} {end_day}, {prev_year}, respectively",
    "{company} {hedge_use_verb} {swap_type} with notional values of {currency_code}{notional1} {money_unit} as of {month} {end_day}, {year} compared to {currency_code}{notional2} {money_unit} as of {month} {end_day}, {prev_year}",
    ...
    "{company} {hedge_use_verb} {swap_type} to hedge forecasted transactions, with notional amounts decreasing from {currency_code}{notional2} {money_unit} as of {month} {end_day}, {prev_year} to {currency_code}{notional1} {money_unit} as of {month} {end_day}, {year}",
    ...
    "At year-end {year}, {swap_type} with a notional amount of {currency_code}{notional1} {money_unit} were {hedge_use_verb} to hedge transactions, compared to {currency_code}{notional2} {money_unit} in {prev_year}",
    "{company} {hedge_use_verb} {swap_type} with a notional value of {currency_code}{notional1} {money_unit} as of {month} {end_day}, {year}, down from {currency_code}{notional2} {money_unit} as of {month} {end_day}, {prev_year}",
    ...
    "As of {month} {end_day}, {year}, {swap_type} {hedge_use_verb} for hedging had a notional value of {currency_code}{notional1} {money_unit}, compared to {currency_code}{notional2} {money_unit} as of {month} {end_day}, {prev_year}",
    ...
    "{company} {hedge_use_verb} {swap_type} with notional amounts of {currency_code}{notional1} {money_unit} as of {month} {end_day}, {year}, versus {currency_code}{notional2} {money_unit} in the prior year",
...
hedge_expiration_templates = [
    "All previously outstanding derivatives expired or were settled during {month} {year}, with no new positions {hedge_use_verb} during the year",
    ...
    "All {swap_type} matured in the {quarter} quarter of {year}, and no new derivative instruments were {hedge_use_verb} during the fiscal year",
...
hedge_policy_templates = [
    ...
    "To achieve its objectives, {company} may enter into derivative financial instruments, such as {swap_type}, in order to limit its exposure to market fluctuations",
]
...
hedge_effectiveness_templates = [
    "{company} {verb}, both at inception and on an on-going basis, whether the derivative instruments that are {hedge_use_verb} in {hedge_type} hedging transactions are highly effective in offsetting the {metric} of hedged items",
...
hedge_impact_verbs = hedge_use_verbs | {
    "may enter into",
    "may utilize",
    "may employ",
    "may use"
...
hedge_no_trading_templates = [
    ...
    "Derivatives are {hedge_use_verb} solely for hedging and risk management, not for speculative trading",
    "{company} does not engage in derivative transactions for speculative purposes",
    "All derivative transactions are {hedge_use_verb} for hedging purposes and not for trading or speculation",
]
...
hedge_impact_templates = [
    ...
    "Movements in market rates {verb} the company's cost structure and profitability",
...
cp_strategy_templates = [
    "{company} {hedge_use_verb} {swap_type} to hedge anticipated changes in {commodity} prices, resulting in {currency_code}{amount} {money_unit} of unrealized gains/losses recorded in OCI",
    "During {month} {year}, {company} {hedge_use_verb} {swap_type} to stabilize {commodity} costs for forecasted production, with {currency_code}{amount} {money_unit} in deferred fair value adjustments",
    "{company} {hedge_use_verb} {swap_type} to manage commodity price risk on forecasted inventory, recognizing {currency_code}{amount} {money_unit} in mark-to-market gains/losses",
    ...
    "{swap_type} were {hedge_use_verb} by {company} in {month} {year} to protect against adverse price movements in {commodity}, with {currency_code}{amount} {money_unit} of unrealized gains/losses",
    "In {month} {year}, {company} {hedge_use_verb} {swap_type} to offset commodity price volatility, recognizing {currency_code}{amount} {money_unit} in fair value adjustments",
    "{company} maintained {swap_type} to hedge production cost exposure for {commodity}, resulting in {currency_code}{amount} {money_unit} recorded in other comprehensive income",
    "During the {quarter} quarter of {year}, {swap_type} were {hedge_use_verb} to manage {commodity} price risk, with {currency_code}{amount} {money_unit} of mark-to-market adjustments",
    "{company} {hedge_use_verb} {swap_type} to mitigate fluctuations in {commodity} prices, recording {currency_code}{amount} {money_unit} in OCI",
    ...
    "{company} {hedge_use_verb} {swap_type} in {year} to secure {commodity} prices, recognizing {currency_code}{amount} {money_unit} in hedge-related gains/losses",
    "To manage {commodity} price exposure, {company} {hedge_use_verb} {swap_type} in {month} {year}, with {currency_code}{amount} {money_unit} in OCI adjustments",
    ...
    "{swap_type} were {hedge_use_verb} by {company} to hedge {commodity} costs, with {currency_code}{amount} {money_unit} recorded as mark-to-market adjustments in {year}",
]
cp_position_templates = [
    "As of {month} {end_day}, {year}, {company} maintains {swap_type} with notional amounts totaling {currency_code}{notional} {money_unit} to hedge commodity price risk",
    ...
    "{company} maintains {swap_type} with a notional amount of {currency_code}{notional} {money_unit} at {month} {end_day}, {year}, designated for commodity risk management",
    "During {year}, {company} {hedge_use_verb} {swap_type} with a total notional value of {currency_code}{notional} {money_unit} to hedge volatility in raw material costs",
    "As of {month} {end_day}, {year}, outstanding {swap_type} totaling {currency_code}{notional} {money_unit} are {hedge_use_verb} to mitigate commodity price exposure",
    ...
    "As of {month} {year}, {company} uses {swap_type} with a notional value of {currency_code}{notional} {money_unit} to manage {commodity} price volatility",
    ...
    "During {year}, {company} maintained {swap_type} with a notional amount of {currency_code}{notional} {money_unit} to protect against commodity market fluctuations",
]
cp_specific_templates = [
    "{company} utilizes {swap_type} to hedge exposure to {commodity} price volatility affecting {cost_type}",
    "The Company enters into {swap_type} to manage the financial impact of fluctuations in {commodity} prices",
    "{swap_type} are {hedge_use_verb} to hedge anticipated {commodity} purchases totaling {volume} {volume_unit} over the next {months} months",
    "In {month} {year}, {company} {hedge_use_verb} {swap_type} to lock in {commodity} prices for {volume} {volume_unit} of forecasted consumption",
    "Commodity price risk related to {commodity} is managed through {swap_type} with notional volumes of {volume} {volume_unit}",
    "{company} maintains {swap_type} to hedge {commodity} price exposure on production inputs",
    "The Company uses {swap_type} to stabilize {cost_type} by hedging approximately {pct}% of anticipated {commodity} requirements",
    ...
    "{company} employs {swap_type} to mitigate {commodity} price risks impacting {cost_type} for {volume} {volume_unit}",
    "To secure stable {cost_type}, {company} uses {swap_type} for {commodity} with maturities extending to {months} months",
...
cp_context_templates = [
    "{company} uses commodity contracts and derivatives to manage price exposure to {commodity}",
    ...
    "Volatility in commodity markets can influence the company's procurement costs and operational results",
    "{company} is exposed to changes in energy, metals, and agricultural prices that may impact financial performance",
    "{company} employs commodity hedging strategies to stabilize input costs and protect profit margins",
    ...
    "{company} uses fixed-price contracts to lock in costs for critical commodities and reduce volatility",
]
cp_impact_templates = [
    ...
    "Movements in {commodity} prices {verb} the company's cost structure and profitability",
    ...
    "{company} have market sensitive instruments in the form of fixed-rate debt instruments and financial derivative instruments {hedge_use_verb} to hedge our exposure to {commodity} price increases",
...
fx_strategy_templates = [
    "{company} {hedge_use_verb} {swap_type} as part of a collar strategy to limit exposure to foreign currency fluctuations within a defined range",
    ...
    "{company} {hedge_use_verb} {swap_type} in a collar structure to manage exposure to currency fluctuations",
    "Collar strategies with {swap_type} were {hedge_use_verb} to hedge foreign exchange risk on international transactions",
    "{company} {hedge_use_verb} {swap_type} as part of a collar to cap currency exposure while retaining some upside potential",
    "in the {quarter} quarter of {year}, {swap_type} were {hedge_use_verb} in a collar strategy to mitigate foreign currency volatility",
    "{company} implemented collar positions with {swap_type} to stabilize foreign exchange impacts",
    "{swap_type} were {hedge_use_verb} in a collar strategy to limit currency risk on forecasted revenue",
    "{company} established {swap_type} within a collar framework to manage foreign exchange exposure",
    "Collar strategies involving {swap_type} were {hedge_use_verb} to hedge currency fluctuations in {year}",
    "{company} {hedge_use_verb} {swap_type} in a collar structure to protect against adverse currency movements",
    "In {month} {year}, {swap_type} were implemented as part of a collar to manage currency risk",
    "{swap_type} within a collar strategy were {hedge_use_verb} to limit exposure to foreign exchange volatility",
    "{company} {hedge_use_verb} collar positions with {swap_type} to hedge currency risk on international contracts",
    "in the {quarter} quarter of {year}, {company} {hedge_use_verb} {swap_type} as part of a collar to manage forex exposure",
    "Collar strategies with {swap_type} were implemented to stabilize currency impacts on forecasted transactions",
    "{company} {hedge_use_verb} {swap_type} in a collar framework to cap foreign exchange risk while retaining flexibility",
    "{company} enter into {swap_type} to manage exposures to changes in foreign exchange rates for anticipated intercompany purchases by those subsidiaries whose functional currencies are not the {major_currency}",
]
...
fx_mitigation_templates = [
    ...
    "{swap_type} are {hedge_use_verb} to convert borrowings into {major_currency} when strategically beneficial",
...
fx_alternative_management_templates = [
    ...
    "Foreign currency debt may be {hedge_use_verb} strategically to create natural hedging relationships",
]
...
fx_cash_pooling_templates = [
    ...
    "Cash pooling structures are {hedge_use_verb} to centralize cash management and provide efficient funding to international operations",
...
fx_debt_optimization_templates = [
    "{company} employs {swap_types} to adjust the currency composition of its debt portfolio, managing exposure to {currency_code} fluctuations",
    "To hedge foreign exchange risk, {company} uses {swap_types} to convert borrowings from {currency_code} into its functional currency",
    ...
    "To manage currency risk, {company} utilizes {swap_types} to modify the currency mix of its debt obligations",
    "{company} uses {swap_types} to convert debt from {currency_code} into other currencies as part of its foreign exchange risk management strategy",
    "The company employs {swap_types} to hedge foreign currency exposure on its international debt portfolio",
    ...
    "To reduce foreign exchange volatility, {company} utilizes {swap_types} to optimize the composition of multi-currency debt",
]
```
...
ir_entry_templates = [
    "In {month} {year}, {swap_type} were {hedge_use_verb} and designated as hedges of the notes with a notional amount of {currency_code}{notional} {money_unit}, effectively converting portions of fixed-rate debt to floating rates",
    "During {month} {year}, {company} {hedge_use_verb} {swap_type} with an aggregate notional value of {currency_code}{notional} {money_unit} to modify the interest rate characteristics of outstanding senior notes",
    "{company} {hedge_use_verb} {swap_type} in {month} {year} with a total notional amount of {currency_code}{notional} {money_unit}, designated as fair value hedges of fixed-rate obligations",
    ...
    "{company} {hedge_use_verb} {swap_type} in {month} {year} with notional amounts aggregating {currency_code}{notional} {money_unit} to hedge interest rate exposure on a portion of its debt portfolio",
    "in the {quarter} quarter of {year}, {company} {hedge_use_verb} {swap_type} with a notional value of {currency_code}{notional} {money_unit} to convert fixed-rate senior notes to variable rates",
    "During {month} {year}, {swap_type} were {hedge_use_verb} with a total notional amount of {currency_code}{notional} {money_unit} to manage interest rate risk on long-term debt",
    ...
    "During {month} {year}, {company} {hedge_use_verb} {swap_type} with a notional amount of {currency_code}{notional} {money_unit} to manage exposure to interest rate fluctuations",
    ...
    "{company} {hedge_use_verb} {swap_type} in the {quarter} quarter of {year} with a notional amount of {currency_code}{notional} {money_unit} to modify the interest rate structure of its senior notes",
    ...
    "During {year}, {company} {hedge_use_verb} {swap_type} with a notional amount of {currency_code}{notional} {money_unit} to convert portions of its fixed-rate debt to floating rates",
    ...
    "{company} {hedge_use_verb} {swap_type} during the {quarter} quarter of {year} with a notional amount of {currency_code}{notional} {money_unit} to manage interest rate exposure on bonds",
    "In {month} {year}, {swap_type} totaling {currency_code}{notional} {money_unit} were {hedge_use_verb} to adjust the interest rate characteristics of long-term liabilities",
...
ir_past_event_templates = [
    "During {month} {year}, {company} {hedge_use_verb} {swap_type} in anticipation of issuing fixed-rate notes, leaving {currency_code}{amount} {money_unit} of unrealized losses in OCI related to {swap_type} as of {month} {next_year}",
    "In {month} {year}, {company} {hedge_use_verb} {swap_type} with a notional value of {currency_code}{amount} {money_unit} to hedge forecasted debt issuances, resulting in deferred losses recorded in accumulated OCI",
    ...
    "During {year}, {swap_type} were {hedge_use_verb} to lock in favorable rates prior to debt refinancing, with {currency_code}{amount} {money_unit} of accumulated losses deferred in other comprehensive income",
    "In {month} {year}, {company} {hedge_use_verb} forward-starting {swap_type} in connection with planned debt offerings, recording {currency_code}{amount} {money_unit} of mark-to-market losses in OCI",
    "In {month} {year}, {company} {hedge_use_verb} {swap_type} to manage interest rate risk, recognizing {currency_code}{amount} {money_unit} in unrealized gains in OCI as of {month} {next_year}",
    "During {year}, {company} {hedge_use_verb} {swap_type} to hedge against fluctuations in interest rates, with {currency_code}{amount} {money_unit} in deferred gains recorded in accumulated OCI",
    ...
    "in the {quarter} quarter of {year}, {company} {hedge_use_verb} forward-starting {swap_type} to secure rates for future debt issuances, with {currency_code}{amount} {money_unit} in mark-to-market adjustments in OCI",
    "In {year}, {company} {hedge_use_verb} {swap_type} to mitigate interest rate exposure, with {currency_code}{amount} {money_unit} in fair value changes deferred in equity",
    ...
    "during the {quarter} quarter of {year}, {company} {hedge_use_verb} {swap_type} to hedge planned bond issuances, with {currency_code}{amount} {money_unit} in unrealized losses recorded in OCI",
    "In {month} {year}, {swap_type} were {hedge_use_verb} to manage exposure to interest rate volatility, resulting in {currency_code}{amount} {money_unit} of deferred gains in equity",
    "{company} {hedge_use_verb} {swap_type} in {month} {year} to hedge forecasted interest payments, with {currency_code}{amount} {money_unit} in mark-to-market adjustments in OCI",
    ...
    "in the {quarter} quarter of {year}, {swap_type} were {hedge_use_verb} to manage interest rate risk on future borrowings, with {currency_code}{amount} {money_unit} in losses recorded in equity",
    "{company} {hedge_use_verb} {swap_type} in {month} {year} to hedge against rising interest rates, deferring {currency_code}{amount} {money_unit} in mark-to-market losses in OCI",
    "In {month} {year}, {company} {hedge_use_verb} {swap_type} with a notional value of {currency_code}{amount} {money_unit}, resulting in deferred gains recorded in accumulated OCI",
    "During {year}, {company} {hedge_use_verb} {swap_type} to lock in rates for planned financings, with {currency_code}{amount} {money_unit} in fair value adjustments in OCI",
...
ir_optional_templates = [
    ...
    "{swap_type} are {hedge_use_verb} to mitigate the risk of rising interest rates on planned fixed-rate debt issuances",
    ...
    "{swap_type} are {hedge_use_verb} as {hedge_type} hedges to lock in rates for anticipated debt financings",
    ...
    "{swap_type} are {hedge_use_verb} to hedge against rising interest rates for planned debt issuances",
...
ir_context_templates = [
    ...
    "{company} {hedge_use_verb} two derivative financial instruments to manage our variable interest rate exposure.",
]
# Interest Rate (IR) Debt Optimization Templates
ir_debt_optimization_templates = [
    "{company} uses {swap_type} to optimize the interest rate profile of its debt portfolio, converting portions of fixed-rate debt to floating-rate instruments",
    "To manage borrowing costs, {company} employs {swap_type} to adjust the effective interest rate composition of outstanding debt",
    "{company} implements {swap_type} to reduce interest rate volatility on its debt obligations",
    "As part of its debt strategy, {company} utilizes {swap_type} to transform fixed-rate debt into variable-rate debt where appropriate",
    ...
    "{company} uses {swap_type} to manage the interest rate exposure of its long-term debt portfolio",
    "The company employs {swap_type} to convert portions of debt into instruments with more favorable interest rate terms",
...
inventory_templates = [
    ...
    "The company records provisions for excess and obsolete inventories based on expected future demand, market conditions, and product life cycles",
]
...
inventory_writedown_templates = [
    ...
    "The company recorded {currency_code}{amount} {money_unit} in inventory write-downs due to declining market demand during {year}",
...
impairment_templates = [
    ...
    "The company assessed recoverability of {asset_type} and recognized an impairment loss of {currency_code}{amount} {money_unit} in {year}",
...
def generate_labeled_hedge_paragraph(
    ...
    if has_active_derivative is None:
        ...
        if random.random() < 0.7:
            ...
            verb = random.choice(hedge_impact_verbs)
            all_sentences.append(
                template.format(
                    company=company_name,
                    verb=verb,
        ...
        all_sentences.append(nt_template.format(company=company_name))
    ...
    # Labels 0 and 1: Specific positions
        ...
        if swapType == "fx":
            ...
            if has_active_derivative:
                ...
                template = random.choice(hedge_active_position_template)
                swap_type = random.choice(swap_types)
        ...
        # Interest Rate specific logic
            ...
            if has_active_derivative:
                ...
                # Active position (always for label 0)
                template = random.choice(ir_active_position_template)
                swap_type = random.choice(swap_types)
                notional = random.randint(100, 1000)
                sentence = template.format(
                    company=company_name,
        ...
        # Commodity Price specific logic
            ...
            if random.random() < 0.6:
                ...
                all_sentences.append(
                    template.format(company=company_name, commodity=commodity)
                )
