...
hedge_may_use_mitigation_templates = [
    "{company} {may_use_verb} {swap_type} to protect against unfavorable changes in market conditions",
    "{company} {may_use_verb} {swap_type} to offset risks associated with forecasted transactions",
    "{company} {may_use_verb} {swap_type} to reduce overall earnings volatility",
    "{company} {may_use_verb} {swap_type} to enhance stability of financial performance",
    "{company} {may_use_verb} {swap_type} to manage risk exposure across multiple markets",
]
...
cp_hedge_may_use_templates = [
    "{company} {may_use_verb} {swap_type} to manage the volatility of commodity prices",
    "{company} {may_use_verb} {swap_type} to reduce the risk of fluctuations in raw material costs",
    "{company} {may_use_verb} {swap_type} to stabilize operating costs tied to commodity inputs",
    "{company} {may_use_verb} {swap_type} to protect margins from unexpected commodity price movements",
    "{company} {may_use_verb} {swap_type} to lock in pricing for forecasted commodity purchases",
]
...
fx_mitigation_templates = [
    ...
    "{company} centrally manages subsidiary liquidity and {verb} {swap_type} to hedge foreign exchange exposure on intercompany funding arrangements",
    ...
    "{company} {verb} {swap_type} to hedge foreign currency risk on centrally managed subsidiary funding and cash movements",
    "{company} may use {swap_type} to adjust the currency profile of its debt portfolio as needed",
    "{company} {verb} {swap_type} to modify the currency composition of borrowings based on operational needs",
    "{swap_type} are {verb} to convert borrowings into {major_currency} when strategically beneficial",
...
fx_alternative_management_templates = [
    ...
    "Foreign currency debt may be {verb} strategically to create natural hedging relationships",
]
...
fx_hedge_may_use_templates = [
    "{company} {may_use_verb} {swap_type} to mitigate exposure to foreign currency movements",
    "{company} {may_use_verb} {swap_type} to manage risks related to forecasted foreign transactions",
    "{company} {may_use_verb} {swap_type} to offset volatility from translating foreign subsidiaries’ results",
    "{company} {may_use_verb} {swap_type} to reduce the impact of exchange rate fluctuations on cash flows",
    "{company} {may_use_verb} {swap_type} to protect against adverse changes in cross-border financing costs",
]
```
...
ir_hedge_may_use_templates = [
    "{company} {may_use_verb} {swap_type} to hedge against fluctuations in interest rates",
    "{company} {may_use_verb} {swap_type} to manage exposure to changes in benchmark interest rates",
    "{company} {may_use_verb} {swap_type} to reduce cash flow variability from interest-bearing debt",
    "{company} {may_use_verb} {swap_type} to stabilize the cost of borrowing",
    "{company} {may_use_verb} {swap_type} to protect against unfavorable changes in long-term debt obligations",
]
    ...
    # Labels 0 and 1: Specific positions
        ...
        if not has_active_derivative:
            ...
            if random.random() < 0.6 and len(past_years) > 0:
                ...
                hedge_type = random.choice(hedge_types)
                hedge_use_verb = random.choice(hedge_use_verbs)
                sentence = template.format(
                    company=company_name,
                    swap_type=swap_type,
                    month=random.choice(months),
