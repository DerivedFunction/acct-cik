...
## Global variables
```{python}
EXCEL_PATH = "post_results_dummy.xlsx"
DB_PATH = "webpage_dummy_results.db"
```
...
training_df = training_df.sample(n=100, random_state=42)
...
training_df.to_excel("training-post-output-dummy.xlsx", index=False)
```
